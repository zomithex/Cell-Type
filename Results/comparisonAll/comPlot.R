# This function, read the Refrence data and the predicted data in a single file (format important) amd make the scatterplot of predicted versus observed for each sample.

comPlot <- function(directory = "C:/Users/user/Desktop/mit", fileName = "lmPlot.csv") {
